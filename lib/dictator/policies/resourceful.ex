defmodule Dictator.Policies.Resourceful do
  ...
  defmacro __using__(opts) do
    quote do
      ...
      @behaviour Resourceful
      @behaviour Policy

      @module Keyword.fetch!(unquote(opts), :for)
      @key Keyword.get(unquote(opts), :key, :id)
      @repo Keyword.get(unquote(opts), :repo, Resourceful.infer_repo_for(@module))

      @impl Policy
      def resourceful?, do: true
